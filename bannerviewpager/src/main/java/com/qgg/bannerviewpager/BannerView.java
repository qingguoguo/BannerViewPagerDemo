...
public class BannerView extends RelativeLayout {
    ...
    public BannerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // 把布局加载到这个View里面
        inflate(context, R.layout.qgg_banner_vp_layout, this);
        initAttribute(attrs);
        initView();
    }
    ...
    private void initAttribute(AttributeSet attrs) {
        ...
        // 获取点的位置
        mDotGravity = array.getInt(R.styleable.BannerView_qgg_dotGravity, mDotGravity);
        // 获取点的颜色（默认、选中）
        ...
        // 获取点的大小和距离
        mDotSize = (int) array.getDimension(R.styleable.BannerView_qgg_dotSize, dip2px(mDotSize));
        mDotDistance = (int) array.getDimension(R.styleable.BannerView_qgg_dotDistance, dip2px(mDotDistance));
